...
var SOAPClient = {
  ...
  escapeSpecialCharacters : function(value){
    if(typeof value === 'string' && value.search(/[&<>\u0900-\uffff]/) !== -1){
      value = value.replace(/[\u0900-\uffff]/g, "");
...
var SOAPObject = function(name) {
	...
	this.val=function(v){if(!v){return this.value;}else{this.value=SOAPClient.escapeSpecialCharacters(v);return this;}};
