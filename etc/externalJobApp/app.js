var init = function(formContainer){
	...
	var sourceField = $(".marketing_options");
	...
	var resumeField = formContainer.find("#file_name");
	...
	var validation = this.validation = {
		...
		"candidateSourceRequired" : new window.c20g.validation.Validator({$el: sourceField, v: "selectAtLeast", c: 1}),
