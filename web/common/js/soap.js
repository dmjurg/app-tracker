/**
 * @namespace Container Soap object. Defines all methods facilitating the
 *            creation of SOAP Requests.<br/>
 */
window.c20g.Soap = {

	/**
	 * @function
	 * @description Function will return a boolean value if the response was not
	 *              returned (internet connectivity issues)<br>
	 *              or an SOAP fault was thrown.
	 * @param {object}
	 *            response The JSON object returned from making a SOAP request
	 *            with the SOAPClient.
	 * @returns {boolean} true or false depending on if the response is valid or
	 *          not.
	 */
	 ...
	 * @param {string}
	 *            methodName The name of the first child element of the
	 *            SOAP:Body (the method name)
	 * @param {string}
	 *            methodNs The namespace of the method being invoked
	 * @param {object[]}
	 *            paramMap An array of maps; each should contain 3 attributes:
	 *            name, value, ns
	 */
	constructSimpleSOAPRequest : function(methodName, methodNs, paramMaps, paramNs) {
		// create and return the soap envelope containing our constructed
		// request body
	 ...
	 * @param {object[]}
	 *            paramMap An array of maps; each should contain 3 attributes:
	 *            name, value, ns (optional)
	 * @param {string}
	 *            paramNS The default namespace for the parameters. this can be
	 *            overridden with the ns attribute in paramMap.
	 */
	constructSimpleSOAPBody : function(methodName, methodNs, paramMaps, paramNs) {
		...
		// loop over the params passed in, and add them to the request body as
		// children
	...
	/**
	 * @function
	 * @description Function traverses a SOAPObject along the given path and
	 *              returns that node if it exists. Returns null if no object is
	 *              found.
	 * @param {object}
	 *            soapObject The SOAPObject to search through.
	 * @param {string[]}
	 *            pathArray The path to search, with each level of the path as a
	 *            string in the array. e.g. ['tuples','tuple','old','SELECTION']
	 */
	 ...
	 * @param {string}
	 *            name The name of the newly constructed SOAPObject
	 */
	 ...
	 * @param {object}
	 *            params The json object representing the first child element of
	 *            the SOAP:Body
	 * @param {string}
	 *            methodName The name of the first child element of the
	 *            SOAP:Body (the method name)
	 ...
	 *            methodNs The namespace of the method being invoked
	 * @param {string}
	 *            paramNS The namespace for all parameters.
	 */
